...
*
*   $Id: buddy_list.php.t,v 1.18 2003/04/21 14:17:50 hackie Exp $
****************************************************************************
...
/*{PRE_HTML_PHP}*/
	...
	if (isset($_POST['add_login'])) {
		if (!($buddy_id = q_singelval('SELECT id FROM SQL_TABLE_PREFIX}users WHERE alias=\''.addslashes($_POST['add_login']).'\''))) {
