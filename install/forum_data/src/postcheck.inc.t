...
* $Id: postcheck.inc.t,v 1.28 2005/07/28 16:07:18 hackie Exp $
*
...
{
	if (!empty($_POST['msg_body']) && $GLOBALS['MAX_IMAGE_COUNT'] && $GLOBALS['MAX_IMAGE_COUNT'] < count_images($_POST['msg_body'])) {
		return -1;
	}
