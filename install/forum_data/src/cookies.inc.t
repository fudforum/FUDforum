...
* $Id: cookies.inc.t,v 1.81 2005/12/07 18:07:45 hackie Exp $
*
...
function ses_get($id=0)
{
	...
	$u = db_sab('SELECT
		...
		u.ignore_list, u.ignore_list, u.buddy_list, u.id, u.group_leader_list, u.email, u.login, u.sq, u.ban_expiry
