...
INSERT INTO {SQL_TABLE_PREFIX}group_cache (user_id, resource_type, resource_id, group_id, p_VISIBLE, p_READ, p_POST, p_REPLY, p_POLL, p_FILE, p_VOTE, p_RATE, p_SML, p_IMG) VALUES (2147483647, 'forum', 1, 3, 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y', 'Y');
