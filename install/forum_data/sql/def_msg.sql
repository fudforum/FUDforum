...
VALUES ('<b>Congratulations!</b> You have successfully installed FUDforum and are well on your way to creating a vibrant community that you and your members can enjoy for years to come.<br />\r\n<br />\r\nTo help you get started, please read the documentation on our <a href="https://github.com/fudforum/FUDforum/wiki">wiki</a> and report any problems in the <a href="https://github.com/fudforum/FUDforum/discussions">support forum</a>.<br />\r\n<br />\r\nLog in and head over to the Admin Control Panel to start configuring your forum.<br />\r\n<br />\r\nThank you for using our software.<br />\r\n<br />\r\nEnjoy!<br />\r\nThe FUDforum Team<br />\r\n');
