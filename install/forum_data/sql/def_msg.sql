...
(1, 2, 0, '127.0.0.1', NULL, {UNIX_TIMESTAMP}, 0, 0, NULL, 'Welcome to FUDforum', 0, 0, -1, 603, 1, -1, 0, 0, NULL, NULL, NULL, 1, 1, NULL, NULL);
...
INSERT INTO {SQL_TABLE_PREFIX}thread_rate_track (id, thread_id, user_id, stamp, rating) VALUES (1, 1, 2, {UNIX_TIMESTAMP}, 5);
