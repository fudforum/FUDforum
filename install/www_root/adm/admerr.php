...
* $Id: admerr.php,v 1.14 2004/04/21 21:04:49 hackie Exp $
*
...
<?php
	...
	if (@file_exists($GLOBALS['ERROR_PATH'].'fud_errors') && filesize($GLOBALS['ERROR_PATH'].'fud_errors')) {
		echo '<h4>FUDforum Error Log [<a href="admerr.php?clear_fud_log=1&'._rsidl.'">clear log</a>]</h4>';
	...
	if (@file_exists($GLOBALS['ERROR_PATH'].'sql_errors') && filesize($GLOBALS['ERROR_PATH'].'sql_errors')) {
		echo '<h4>SQL Error Log [<a href="admerr.php?clear_sql_log=1&'._rsidl.'">clear log</a>]</h4>';
