...
*
*   $Id: admerr.php,v 1.1 2002/08/28 18:39:27 hackie Exp $
****************************************************************************
...
<?php
	if( @file_exists($GLOBALS['ERROR_PATH'].'fud_errors') && filesize($GLOBALS['ERROR_PATH'].'fud_errors') ) {
		echo '<h4>FUDforum Error Log [<a href="admerr.php?clear_fud_log=1&<? echo _rsid; ?>">clean log</a>]</h4>';
		echo '<table border=1 cellspacing=1 cellpadding=3><tr bgcolor="#bff8ff"><td nowrap>Time (<b>GMT</b>)</td><td>Error Description</td></tr>';
	...
	if( @file_exists($GLOBALS['ERROR_PATH'].'sql_errors') && filesize($GLOBALS['ERROR_PATH'].'sql_errors') ) {
		echo '<h4>SQL Error Log [<a href="admerr.php?clear_sql_log=1&<? echo _rsid; ?>">clean log</a>]</h4>';
		echo '<table border=1 cellspacing=1 cellpadding=3><tr bgcolor="#bff8ff"><td nowrap>Time (<b>GMT</b>)</td><td>Error Description</td></tr>';
