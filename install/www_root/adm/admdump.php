...
* $Id: admdump.php,v 1.78 2009/04/04 08:18:46 frank Exp $
*
...
function backup_dir($dirp, $fp, $write_func, $keep_dir, $p=0)
{
	...
	if (isset($_POST['submitted'])) {
		...
		echo '<div class="tutor">The backup file can be found at: <b>'.$_POST['path'].'</b>. It is occupying '.filesize($_POST['path']).' bytes.</div><br />';
	} else {
