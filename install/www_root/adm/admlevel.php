...
* $Id: admlevel.php,v 1.26 2005/07/28 16:07:18 hackie Exp $
*
...
**/
	...
	if (isset($_POST['lev_submit'])) {
		q("INSERT INTO ".$DBHOST_TBL_PREFIX."level (name, img, level_opt, post_count) VALUES ('".addslashes($_POST['lev_name'])."', ".ssn($_POST['lev_img']).", ".(int)$_POST['lev_level_opt'].", ".(int)$_POST['lev_post_count'].")");
	} else if (isset($_POST['edit'], $_POST['lev_update'])) {
		q("UPDATE ".$DBHOST_TBL_PREFIX."level SET name='".addslashes($_POST['lev_name'])."', img=".ssn($_POST['lev_img']).", level_opt=".(int)$_POST['lev_level_opt'].", post_count=".(int)$_POST['lev_post_count']." WHERE id=".(int)$_POST['edit']);
	}
