...
<?php
	...
	while ( $obj = db_rowobj($r) ) {
		...
		if ( $obj->id > 2 ) 
			$user_grp_mgr = " ".$del_link."[<a href=\"admgrouplead.php?group_id=$obj->id&rnd=".get_random_value()."&"._rsid."\">Manage Leaders</a>] [<a href=\"../groupmgr.php?group_id=$obj->id&"._rsid."\" target=_new>Manage Users</a>]";
