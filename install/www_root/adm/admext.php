...
* $Id: admext.php,v 1.15 2004/04/21 21:04:49 hackie Exp $
*
...
<?php
	...
	while ($r = db_rowarr($c)) {
		...
		echo '<tr '.$bgcolor.'><td>'.htmlspecialchars($r[0]).'</td><td>[<a href="admext.php?edit='.$r[1].'&'._rsidl.'">Edit</a>] [<a href="admext.php?del='.$r[1].'&'._rsidl.'">Delete</a>]</td></tr>';
	}
?>
